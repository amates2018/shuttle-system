...
package io.peanutsdk.transitions;
...
import io.peanutsdk.widget.BaselineGridTextView;
...
public class ReflowText extends Transition {
    ...
    private static final String PROPNAME_DATA = "prop:reflowtext:data";
    private static final String PROPNAME_TEXT_SIZE = "prop:reflowtext:textsize";
    private static final String PROPNAME_BOUNDS = "prop:reflowtext:bounds";
